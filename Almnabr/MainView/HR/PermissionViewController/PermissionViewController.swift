...
class PermissionViewController: UIViewController {
    ...
    private func confgDropDowns(){
        ...
        dropDownSearch.selectionAction = { [unowned self] (index: Int, item: String) in
            ...
            self.getPermissionMentionsData()
        }
...
extension PermissionViewController:UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.delegate = self
        print("XXX-TEST",data[indexPath.row])
...
extension PermissionViewController{
    private func getPermissionMentionsData(){
        showLoadingActivity()
        
        APIController.shard.getPermissionMentionsData(searchBranchId: searchBranchId, groupId: groupId, userId: userId) { data in
